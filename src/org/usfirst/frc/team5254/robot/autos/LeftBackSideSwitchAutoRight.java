 ...
 *
 */
public class LeftBackSideSwitchAutoRight extends CommandGroup {

    public LeftBackSideSwitchAutoRight() {
    ...
    /** Drive over to other side of field **/
	    ...
	    addSequential(new RunPath(Paths.FROM_LEFT.BACK_SWITCH_BACKUP, -0.75, 1));
