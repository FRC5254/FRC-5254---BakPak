...
public class RobotMap {
	...
	// CAN Talon
	public static final int ELEVATOR = 6;// 6
	public static final int DRIVETRAIN_LEFT = 2;//2
	public static final int DRIVETRAIN_LEFT2 = 10;//10
	public static final int DRIVETRAIN_RIGHT = 9;//9
	public static final int DRIVETRAIN_RIGHT2 = 12;//12
	// Misc
